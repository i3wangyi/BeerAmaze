...
mediump vec4 frag( in v2f i ) {
    ...
    highp float scale = 0.2;
    #line 334
    c.xyz = (((c.xyz * scale) + 1.0) - scale);
    return c;
}
...
; 2 ALU, 1 TEX
dcl_2d s0
def c0, 0.20000000, 0.80000001, 0, 0
dcl t0.xy
texld r0, t0, s0
...
abaaaaaaaaaaahacaaaaaakeacaaaaaaaaaaaaffabaaaaaa add r0.xyz, r0.xyzz, c0.y
